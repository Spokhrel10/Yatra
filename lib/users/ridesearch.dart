...
class _OutSearchScreenState extends State<OutSearchScreen> {
  ...
  Future<void> _savedData() async {
    ...
    final snapshot = await db
        ...
        .where('vehicle_type', isEqualTo: widget.type)
        .get();
  ...
  void initState() {
    ...
    typeControl = TextEditingController(text: widget.type);
    _savedData();
    _getDataList();
    _savedData1();
    _savedData7();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    margin: const EdgeInsets.only(left: 22, top: 12),
                    child: Text(
                      "${widget.leaving?.split(',')[0].trim().toUpperCase()}",
                      style: TextStyle(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              UiHelper.horizontaSpace(
                                                  hspace: Spacing.small),
                                              Text(
                                                "${int.parse(snapshot.data!.docs[index]['vehicle_seats'].toString())} Seats",
                                                style: TextStyle(
                                                  fontFamily: "PublicSans",
                                                  fontWeight: FontWeight.w500,
                                                  color:
